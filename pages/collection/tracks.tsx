      ...
      {likedTracks && (
        <>
          <div className="flex items-end gap-6">
            <Image src="https://t.scdn.co/images/3099b3803ad9496896c43f22fe9be8c4.png" alt="Liked Songs" height={208} width={208} />
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-5 text-sm">
                ...
                {likedTracks.items.length > 0 && <span className="text-gray">{likedTracks.total} songs</span>}{' '}
              </div>
            </div>
          </div>
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
  ...
  const likedTracks = await customGet(`https://api.spotify.com/v1/me/tracks?market=from_token&limit=50`, session);
